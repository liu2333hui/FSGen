...
def SRAMSPrimitiveTest( out_features = ['Total_Pwr','Unit_Cycles', 'Energy'], train = 0):
	ap = SRAMSPrimitive()
	#train_sets =glob.glob("generated/Multiplier2/1753*")
	...
	df1 = pd.read_csv('generated/SRAMBanked//1753857441956.txt', delimiter='\t')
	df2 = pd.read_csv('generated/SRAMBanked//1753847414747.txt', delimiter='\t')
