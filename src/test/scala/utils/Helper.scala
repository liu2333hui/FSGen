...
//def GenCombo[A]( M: Map[String,Array[_ >: String with Boolean with Int with Double with Array[Array[String]] with Array[Array[Int]] with Array[Int] with Array[String]  ]] ) = {
